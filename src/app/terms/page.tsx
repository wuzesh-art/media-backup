export const metadata = {
  title: "Terms of Service - MediaBackup Pro",
  description: "Terms of service for MediaBackup Pro video backup tool.",
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing and using MediaBackup Pro, you accept and agree to be bound by the terms of this agreement.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>MediaBackup Pro is provided on an &quot;as is&quot; basis. We make no warranties, expressed or implied.</p>
          </section>
          <section>
